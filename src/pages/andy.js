...
function IndexPage() {
  return (
    <Layout>
      ...
      <Header PageTitle="Andrea Carranza" />
      
      <section>
        <div class="max-w-xl md:max-w-3xl lg:max-w-4xl mx-auto">
        <p>
            Andrea Carranza es una psicóloga clínica costarricense, con estudios en arte-terapia y psicoanálisis. Es una de las fundadoras y actual Directora General de la asociación Sueña en Colores. Fundó el proyecto <b>Adentro</b> a partir de sus estudios y la práctica de Mindfulness. Actualmente trabaja como terapeuta a nivel privado en la Clínica Litoral.
          </p>
